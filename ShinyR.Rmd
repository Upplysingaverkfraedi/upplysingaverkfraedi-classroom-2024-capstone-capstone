...
ui <- fluidPage(
  ...
  tabsetPanel(
    tabPanel("Heim",
             ...
             p("Gröf og ýmsar töflur varaðandi frammistöðu leikmanna og liða á tilteknu tímabili"),
             p("Notið takkana til að flakka á milli niðurstaðna og grafa")
    ),
    tabPanel("Síðustu ár",
      sidebarLayout(
        sidebarPanel(
...
server <- function(input, output, session) {
  ...
  Stadiums_data <- Stadiums_data %>%
    mutate(Logo_url = paste0("C:/Users/jakob/Desktop/capstone-thereach/Logos/", str_replace_all(Team, " ", "_"), ".png"))
